...
Format your response in markdown to make it easier to render to a web page, format as clean Markdown suitable for ReactMarkdown rendering, start directly with the recipe title as an H1 header.
The ingreadients and equipement format is same with the instruction (same style and the allignment). Here is the task: generate a recipe using the following ingredients: ${ingredientsString}`;
