...
//   return (
//     <h1>React is great! and I start to learn it.</h1>
//   )
// }
// /**
//  * Challenge:
...
// newH1.textContent = "I just do my challenge and hope it work"
// newH1.className = "header"
// document.getElementById('root').appendChild(newH1)

//ABOVE IS HOW TO RENDER OUT THE SIMPLE H1 IN JS AND HOW EASY WITH REACT
import { createRoot } from 'react-dom/client'
const root = createRoot(document.getElementById("root"))

root.render(
  <div><h1 className='header'></h1>Every thing must easier with React!</div>
)
